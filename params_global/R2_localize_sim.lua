...
options = {
  ...
  odom_frame = "odom_r2",  -- name of the odometer frame
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 10  -- Max is 100
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 0.8 -- default 0.01
