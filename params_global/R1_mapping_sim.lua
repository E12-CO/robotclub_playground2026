...
options = {
  ...
  tracking_frame = "imu_link_r1",  -- tracking frame name
...
TRAJECTORY_BUILDER_2D.max_range = 20.0  -- the maximum scanning range of the lidar
...
TRAJECTORY_BUILDER_2D.use_online_correlative_scan_matching = false  -- Whether to scan for matches using real-time loopback detection
-- TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 0.2 -- Default 0.1

-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 1.
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 12e0
