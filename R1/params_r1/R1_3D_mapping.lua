...
options = {
  ...
  tracking_frame = "unilidar_imu_r1",  -- tracking frame name
...
MAP_BUILDER.use_trajectory_builder_2d = true  -- use 2D tranjectory builder
...
TRAJECTORY_BUILDER_2D.min_range = 1.0  -- ignore anything smaller than the robot radius, limiting it to the minimum scan range of the lidar
TRAJECTORY_BUILDER_2D.max_range = 30.0  -- the maximum scanning range of the lidar
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 20.0  -- Restricted to maximum LiDAR scanning range  
...
-- POSE_GRAPH.optimize_every_n_nodes = 60 -- Original 60
