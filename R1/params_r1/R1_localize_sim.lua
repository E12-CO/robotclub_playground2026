...
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.50  -- Modify 0.6 as 0.7, Minimum global positioning score below which global positioning is considered currently inaccurate
